...
echo  "<a href='modelo/buscar_perfil.php?id=" . $idEmpleado. " & apellido=" . $fila['Apellido'].  " & nombre=" . $fila['Nombre'].  " & seccional=" . $fila['Seccional'].  " & facultad=" . $fila['Facultad'].  "& cargo=" . $fila['Cargo'].  "  & salario=" . $fila['Salario'].  " & comienzo=" . $fila['Fch_comienzo'].  " & nacimiento=" . $fila['Fch_nacimiento'].  " & foto=" . $fila['FOTO'].  "'><img src='img/Profile-icon.png' name='del' id='del' width='20px'></a> </td><td class='eliminar'> ";
